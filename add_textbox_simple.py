#!/usr/bin/env python3
"""
Simplified script to add text boxes to PowerPoint slides with better formatting
"""
...
def add_textboxes_to_slide2():
    """Add text boxes to slide 2 with improved formatting (no hyperlinks)"""
    ...
    backup_path = f"/Users/alexanderfedin/Projects/nolock.social/marketing/slide_02_backup_simple_{timestamp}.pptx"
    ...
    for i, point in enumerate(bullet_points):
        ...
        run.font.size = Pt(14) if point.get("level", 0) == 0 else Pt(12)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Add simplified text boxes to PowerPoint slide 2')
